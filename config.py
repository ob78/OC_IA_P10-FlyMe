...
class DefaultConfig:
    ...
    """
    LUIS_APP_ID = "8a4ed91c-a5c7-4a15-8414-43801a515d4b"
    LUIS_API_KEY = "2fca13acb42e4316845726a8b7bfeaf8"
    LUIS_API_HOST_NAME = "westeurope.api.cognitive.microsoft.com"
    LUIS_API_ENDPOINT = "https://luis-ocia.cognitiveservices.azure.com/"
    """
